...
def test_add_contact(app):
    ...
    app.contact.fill_contact_form(Contact (name="name", middlename="middlename", lastname="lastname", nickname="nickname", title="title", company="company", address_1="address, 1",
