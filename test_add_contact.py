...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.fill_contact_form(wd, "name", "middlename", "lastname", "nickname", "title", "company", "address, 1",
                               "55555", "22222", "33333", "44444", "email1@mail.ru", "email2@mail.ru", "email3@mail.ru",
                               "homepage", "1", "January", "2000", "2", "February", "2000", "address, 2", "home2",
                               "notes")
    ...
    def fill_contact_form(self, wd, name, middlename, lastname, nickname, title, company, address_1, phone_home,
                          mobile_home, phone_work, fax, email_1, email_2, email_3, homepage, bday, bmonth, byear, aday,
                          amonth, ayear, address_2, phone_home_2, notes):
        ...
        wd.find_element_by_name("mobile").send_keys(mobile_home)
        ...
        wd.find_element_by_name("phone2").send_keys(phone_home_2)
